...
$supported_extensions = array(
    ...
    // PRO script has extended list of supported extensions
    // See a demo of the pro version here: http://whoislookupscript.com/demo_pro_script.php
);
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!count($errors)) {
        ...
        if (stristr($response, $no_match_string)) {
            $domain_registered_message = "<span style=\"color:#009900\"><b>" . htmlentities($domain . $extension) . " is not registered</b></span>";
        } else {
            $domain_registered_message = "<b>" . htmlentities($domain . $extension) . " is registered</b>";
        }
    }
}
...
<body>
    <div class="container">
        ...
        <br/>
        <br/>
        Powered by <a href="http://whoislookupscript.com/" style="color: #0000ff">WHOIS Lookup Script</a>
    </div>
</body>
</html>
